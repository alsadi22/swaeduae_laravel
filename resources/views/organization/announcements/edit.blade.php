...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="mt-2 text-gray-600">Edit "{{ $announcement->title }}"</p>
            </div>
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <form method="POST" action="{{ route('organization.announcements.update', [$event, $announcement]) }}">
                @csrf
                @method('PUT')
                            ...
                            <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                <div class="flex items-center">
                                    <input id="type_general" name="type" type="radio" value="general" 
                                           ...
                                           {{ old('type', $announcement->type) === 'general' ? 'checked' : '' }}>
                                ...
                                <div class="flex items-center">
                                    <input id="type_update" name="type" type="radio" value="update" 
                                           class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300"
                                           {{ old('type', $announcement->type) === 'update' ? 'checked' : '' }}>
                                ...
                                <div class="flex items-center">
                                    <input id="type_urgent" name="type" type="radio" value="urgent" 
                                           class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300"
                                           {{ old('type', $announcement->type) === 'urgent' ? 'checked' : '' }}>
