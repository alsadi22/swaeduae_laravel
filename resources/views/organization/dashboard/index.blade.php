            ...
            <div class="py-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Welcome back, {{ $organization->name ?? 'Organization' }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ number_format($pendingApplications ?? 0) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ number_format($activeEvents ?? 0) }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-6">
                        @if(isset($recentApplications) && $recentApplications->count() > 0)
                                ...
                                @foreach($recentApplications as $application)
                                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-gray-900">{{ $application->user->name ?? 'Unknown User' }}</p>
                                                <p class="text-sm text-gray-500">{{ $application->event->title ?? 'Unknown Event' }}</p>
                                            </div>
                                        </div>
                            ...
                            <div class="mt-6">
                                <a href="{{ route('organization.volunteers.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Applications for your events will appear here.</p>
                                <div class="mt-6">
                            ...
                            @foreach($topEvents as $event)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $event->start_date->format('M j, Y') ?? 'Date TBD' }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
